...
exports.createProduct = async (req, res) => {
  ...
  if (!file) {
    filePath =
      "https://slfmotion.com/cdn/shop/t/21/assets/placeholder_600x.png?v=113555733946226816651673018228";
  } else {
  ...
  if (
    ...
    return res.status(400).json({
      message:
        "please provide productName,productDescription,productPrice,productStatus,productSize",
    });
  }
...
exports.getCurrentProductsByUser = async (req, res) => {
...
exports.getHistoryProductsByUser = async (req, res) => {
  const productsByUser = await product.find({
    user: req.user._id,
...
exports.editProduct = async (req, res) => {
  ...
  if (
    ...
    return res.status(400).json({
      message:
        "Please provide productName,productDescription,productBoughtPrice,productSellingPrice,productStatus,productSize,id",
    });
  }
